  ...
  items: [
    {
      ...
      situation: '스케일아웃 시 컨슈머 리밸런싱이 발생하면서 동일 주문 이벤트가 두 번 처리되어 재고가 잘못 차감됐습니다.',
      sections: [
        { label: '상황', tone: 'ok' },
        { label: '해결', tone: 'ok' },
        { label: '결과', tone: 'ok' },
    ...
    },
    {
      ...
      situation: '주문 목록 조회 시 연관 엔티티마다 추가 쿼리가 발생해 100건 기준 응답이 3초까지 늘어졌습니다.',
      sections: [
        { label: '상황', tone: 'ok' },
        { label: '해결', tone: 'ok' },
        { label: '결과', tone: 'ok' },
    ...
    },
    {
      ...
      situation: '캐시 만료 직후 다수 요청이 동시에 DB로 몰리면서 커넥션 풀이 고갈됐습니다.',
      sections: [
        { label: '상황', tone: 'ok' },
        { label: '해결', tone: 'ok' },
